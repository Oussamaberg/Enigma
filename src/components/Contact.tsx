...
function Contact() {
  return (
    <div className=" w-full h-full sm:w-10/12 2xl:w-1/2  flex flex-col dark:bg-black rounded-lg  shadow-2xl gap-20 p-4 dark:shadow-xl dark:shadow-cyan-500/50">
      ...
      <div className="relative">
        ...
        <motion.div
          ...
          className="absolute top-3 left-[220px] md:left-[320px] text-2xl "
        >
          <a href="https://www.linkedin.com/in/oussama-berghai-889205197/">
            {" "}
            Oussama-Berghai.connect{" "}
          </a>
        </motion.div>
      </div>
      <div className="flex justify-center ">
        ...
        >
          <a href="mailto:ossama.berghai@gmail.com">
            <div className="bg-white dark:bg-black p-5 roundced-xl">
              Sent Mail
            </div>
          </a>
        </motion.div>
