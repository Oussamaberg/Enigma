...
function Contact() {
  ...
  return <div className=" absolute  top-10 w-full sm:w-10/12 2xl:w-1/2  flex flex-col dark:bg-black rounded-lg  shadow-2xl gap-20 p-4 dark:shadow-xl dark:shadow-cyan-500/50" >
